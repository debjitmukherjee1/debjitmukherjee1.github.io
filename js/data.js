...
const siteData = {
  ...
  ticker: [
    ...
    { label: "GOOGL",      value: "BUY · TP $390",           direction: "up",   sectionId: "models",      page: "research.html" },
    { label: "TCS",        value: "BUY · TP ₹2,502",         direction: "up",   sectionId: "models",      page: "research.html" },
    { label: "V",          value: "BUY · TP $373",           direction: "up",   sectionId: "models",      page: "research.html" },
  ...
  models: [
    ...
    },
    {
      ...
      featured: false,
      date: "Jul 2026",
      thesis: "Great company, wrong price — downgraded to REDUCE at ~40x earnings.",
      rating: "REDUCE",
      targetPrice: "$215 (−34%)",
      impliedValue: "",
      detail: "Refreshed on FY2025 10-K actuals and H1 FY2026 records: revenue $416.2bn (+6.4%), gross margin at a new high of 46.9%, operating margin 32.0%, and H1 FY2026 revenue growth of 16%+. The business is executing superbly — but at $327 the stock trades at ~40x trailing earnings, a ~55% premium to mega-cap peers. Blended fair value (40% DCF / 30% P/E / 20% EV/EBITDA / 10% peer relative) of $215. Downgraded from BUY on price, not the franchise.",
