...
const siteData = {
  ...
  models: [
    ...
    },
    {
      ...
      targetPrice: "$275 (+14%)",
      impliedValue: "",
      detail: "FY2025 revenue of $716.9bn (+13%) with operating income compounding far faster than sales as the mix shifts to services. Valued sum-of-the-parts — AWS carries the bulk of the value, advertising is a ~$70bn high-incremental-margin business — supporting fair value near $275.",
    ...
    },
    {
      ...
      sector: "Banking",
      date: "Jun 2026",
      thesis: "Superb franchise, full price.",
      rating: "HOLD",
      targetPrice: "₹1,199 (−6.3%)",
      impliedValue: "",
      detail: "India's second-largest private-sector bank, with the 'One Bank, One ROE' philosophy behind its post-2018 transformation. Excess-return model (cost of equity 10.8%, terminal growth 5.5%) values it at ₹1,199 — about 6% below the market price.",
